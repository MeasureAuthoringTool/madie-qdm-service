...
public class HQMFMeasureObservationLogicGenerator extends HQMFClauseLogicGenerator {
  ...
  private Map<String, Node> clauseLogicMap = new HashMap<>();
  ...
  private static final Map<String, String> FUNCTIONAL_OPS_AGGREGATE =
      new TreeMap<>(String.CASE_INSENSITIVE_ORDER);

  /** MAP of Functional Ops INCLUDED FUNCTIONS that can be used in Measure Observation. */
  private static final Map<String, String> INCLUDED_FUNCTIONAL_NAMES =
      new TreeMap<>(String.CASE_INSENSITIVE_ORDER);
  ...
  private void generateMOClauseLogicForDateTimeDiff(
      Node clauseNodes, List<Node> elementRefList, Element measureObDefinitionElement)
      throws XPathExpressionException {
   ...
   */
  private List<Node> findFirstLHSElementRef(
      Node firstChildNode, List<Node> arrayList, Element measureObDefinitionElement) {
  ...
  private String generateValueAndExpressionTag(
      List<Node> elementRefList, Element measureObDefinitionElement, String clauseLocalVariableName)
      throws XPathExpressionException {
